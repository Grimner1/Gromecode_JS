...
// const list = [promiseNumber1, promiseNumber2, promiseNumber3];
/*
...
const promise = (...list) => Promise.all(list);
...
// resultPromise(promiseNumber1, promiseNumber2, promiseNumber3).then((el) => console.log(el));
